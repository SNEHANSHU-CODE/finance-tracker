            ...
            <div className="bg-white rounded-4 shadow-sm p-4 p-md-5">
              ...
              <section className="mb-5">
                ...
                <p className="text-muted lh-lg mb-4">
                  ArthFlow is an AI-powered web application that helps you manage your personal finances.
                  Our service allows you to track expenses, manage budgets, analyse your financial patterns,
                  securely store and query financial documents via a Document Vault, and interact with an
                  intelligent AI Assistant. Google Calendar integration is also available for syncing
                  financial reminders and events.
                </p>
                    ...
                    <div id="acceptable-use" className="accordion-collapse collapse" data-bs-parent="#userResponsibilities">
                      <div className="accordion-body">
                        <ul className="text-muted mb-0">
                          ...
                          <li>You must have the legal right to upload any document placed in the Vault. Do not upload documents belonging to others without their consent.</li>
                          <li>Do not attempt to use the AI Assistant to extract other users' data or to generate harmful, misleading, or fraudulent financial content.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
              ...
              <section className="mb-5">
                <div className="d-flex align-items-center mb-3">
                  ...
                  <h2 className="h3 mb-0 text-dark">AI Assistant Disclaimer</h2>
                </div>
                <div className="border border-warning border-opacity-25 rounded-3 p-4 bg-warning bg-opacity-5">
                  <h4 className="h5 text-warning mb-3">Important: AI is not a Financial Advisor</h4>
                  <ul className="text-muted mb-3">
                    <li>The ArthFlow AI Assistant is provided for informational and analytical purposes only. It does <strong>not</strong> constitute certified financial, tax, investment, or legal advice.</li>
                    <li>AI responses are generated by third-party language models (Groq / Google Gemini) and may occasionally be inaccurate, incomplete, or outdated — this is known as an AI "hallucination".</li>
                    <li>Always verify any financial figures, decisions, or strategies with a qualified professional before acting on them.</li>
                    <li>ArthFlow is not liable for any financial loss or damage resulting from reliance on AI-generated responses.</li>
                    <li>Your queries are processed with PII masking, but you should avoid sharing highly sensitive information (e.g., full card numbers, passwords) in the chat.</li>
                  </ul>
                </div>
              </section>
